package com.springdev.taskmanagementapp.event.listener;
...
public class RegistrationCompleteEventListener implements ApplicationListener<RegistrationCompleteEvent> {
    ...
    public void onApplicationEvent(RegistrationCompleteEvent event) {
        ...
        tokenService.saveVerificationTokenForUser(user, vToken); // Problem Occcurrrrrr
    ...
    private static void emailMessage(String subject, String senderName,
        ...
        messageHelper.setFrom("ghoshsayan464@gmail.com", senderName);
